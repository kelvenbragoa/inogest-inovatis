        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{route('absence.create')}}" class="btn btn-pill btn-primary"><i class="far fa-plus"></i>{{__('text.add')}}</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-action">
                                    <a href="{{URL::to('/absence/'.$item->id.'/edit')}}"><i class="align-middle" data-feather="edit-2"></i></a>
                                    <!--<a href="{{URL::to('/absence/'.$item->id)}}"><i class="align-middle" data-feather="eye"></i></a>-->
                                    <a href="" data-toggle="modal" data-target="#exampleModalCenter{{$item->id}}"><i class="align-middle" data-feather="trash"></i></a>
                                </td>
                            </tr>
                            @include('admin.absence.modaldelete')
                            @endforeach
