    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{__('message.delete_header')}} <br>"{{$item->user}}"</h5>
        ...
        <div class="modal-body">
            {{__('message.delete_body_default')}}
        </div>
        
        <div class="modal-footer">
            <form method="POST" action="{{ route('accountmanagement.destroy', $item->id)}}">
                @csrf
                @method('DELETE')
