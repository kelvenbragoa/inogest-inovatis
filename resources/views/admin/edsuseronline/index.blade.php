...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3">{{__('text.edsuseronline')}}</h1>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                         <div class="col-sm-2">
                            <a href="{{route('edsuseronline.create')}}" class="btn btn-pill btn-primary"><i class="far fa-plus"></i>{{__('text.add')}}</a> 
                      ...
                      @include('admin.edsuseronline.modalsearch')
                </div>
                            ...
                            @foreach ($edsuseronline as $item)
                                <tr>
                                    ...
                                    <td class="table-action">
                                        <a href="{{URL::to('/edsuseronline/'.$item->id.'/edit')}}"><i class="align-middle" data-feather="edit-2"></i></a>
