    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">{{__('message.delete_header')}} <br>"{{$item->motivo}}"</h5>
        ...
        <div class="modal-body">
            {{__('message.delete_body_mcscr')}}
        </div>
        <div class="modal-footer">
            <form method="POST" action="{{ route('mcscr.destroy', $item->id)}}">
                @csrf
                @method('DELETE')
