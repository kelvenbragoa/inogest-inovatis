        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">{{__('text.position')}}</h5>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('position.store')}}">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" id="name" placeholder="{{__('text.position')}}" value="{{ old('name') }}" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="{{__('text.description')}}" rows="5" value="{{ old('description') }}" required></textarea>
                            </div>
